...
- **DEB822 Component Fix**: Fixed duplicated components in generated `.sources` files.
- **Repository List UI**: Added text ellipsis to prevent horizontal scrolling with long component strings.

### 🆕 What's new in version 2.0.2-1
- Release date: March 10, 2026
- **Repository Detection**: Improved detection of mirrors and regional repositories.
- **Parser Fix**: Fixed detection of commented-out repositories in legacy format.
- **Performance**: Optimized `pkexec` calls to reduce password prompts.

### 🆕 What's new in version 2.0.2
- Release date: January 9, 2026
- **Documentation**: Added complete manual page and Debian copyright file.
- **Packager Integration**: Updated build system to automatically include documentation.
